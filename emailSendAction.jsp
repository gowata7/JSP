...
<% 
	...
	String host = "http://localhost:8080/MainWeb/";
	String from = "inhoTestEmail@gmail.com";
	String to = userDAO.getUserEmail(uid);
	String subject = "테스트를 위한 이메일 인증 메일입니다.";
...
<section class="container mt-3" style="max-width: 560px;">
	...
	<form method="post" action="userLogoutAction.jsp">
			<table border=1>
